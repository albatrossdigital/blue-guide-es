...
Filters = function() {
  ...
  this.fields = {
    ...
    "Sectores de la población atendidas": {
      label: "Poblaciónes atendidas",
      type: "select",
      msg: "Seleccionar",
      startCol: "CB",
  ...
  this.displayFields = [
    {
      ...
      col: "Sectores de la población atendidas"
    }, {
      label: "Idiomas",
